...
if(USE_CUDA)
  ...
  list(APPEND TVM_RUNTIME_LINKER_LIBS_NO_LIBCUDASO ${CUDA_CUDART_LIBRARY})
  if (NOT CUDA_COMPILE_ONLY)
    list(APPEND TVM_RUNTIME_LINKER_LIBS_NO_LIBCUDASO ${CUDA_CUDA_LIBRARY})
  endif()
  list(APPEND TVM_RUNTIME_LINKER_LIBS_NO_LIBCUDASO ${CUDA_NVRTC_LIBRARY})
  ...
  if(USE_CUDNN)
    ...
    list(APPEND TVM_RUNTIME_LINKER_LIBS_NO_LIBCUDASO ${CUDA_CUDNN_LIBRARY})
  endif(USE_CUDNN)
  ...
  if(USE_CUBLAS)
    ...
    list(APPEND TVM_RUNTIME_LINKER_LIBS_NO_LIBCUDASO ${CUDA_CUBLAS_LIBRARY})
  endif(USE_CUBLAS)
